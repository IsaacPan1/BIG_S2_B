...
| Buffer | 30 min | Reserved for retries and fallback logic |
...
| `modeler` | `reports/schema_analysis.md`, `reports/features.json`, `data/features_train.parquet`, `data/features_val.parquet` | `reports/model_results.json`, `reports/predictions.csv` (columns: `row_id`, identifier cols, `predicted_target`), `reports/modeler_was_here.txt` |
...
| `submission_writer.md` | `submission_writer` | **exists** | Step 4 — after modeler produces predictions |
